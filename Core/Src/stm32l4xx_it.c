...
void EXTI4_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(CUR_R_Pin);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(CUR_D_Pin);
  HAL_GPIO_EXTI_IRQHandler(CUR_OK_Pin);
  HAL_GPIO_EXTI_IRQHandler(CUR_L_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(CUR_U_Pin);
